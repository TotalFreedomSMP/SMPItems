...
public class CustomItem
{
    ...
    public CustomItem(String name, Material type, Rarity rarity, ItemType itemType)
    {
        ...
        {
            case MELEE:
                variant = getRandomVariant(Groups.MELEE_VARIANTS);
                break;
            case RANGED:
                variant = getRandomVariant(Groups.RANGED_VARIANTS);
                break;
            case ARMOR:
                variant = getRandomVariant(Groups.ARMOR_VARIANTS);
                break;
            case SHIELD:
                variant = getRandomVariant(Groups.SHIELD_VARIANTS);
                break;
            case TOOLS:
                variant = getRandomVariant(Groups.TOOLS_VARIANTS);
                break;
        }
